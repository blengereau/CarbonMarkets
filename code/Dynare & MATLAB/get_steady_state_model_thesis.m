function [lambda_2,c_2,w,l_2,i,t_2,y,a,g,...
    ...
    s, p_1, e_1,p_2, e_2, p_e] = ...
    get_steady_state_model_thesis( ...
...
% x(12) - l0;   
x(11) - ((1-tau_i)*x(3)*x(12) + x(13))/x(30) ;
...
x(5) - (rK*x(8) + (1-tau_i)*x(3)*x(4) + x(28)/(1-omega_s) + x(6) - x(32)*x(2)); % Savers budget constraint
...
% x(14) - tau*x(26) ;                         % Government Budget Constraint
